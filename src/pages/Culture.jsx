        ...
        <div className=" w-full">
            ...
            <div className=" w-full pt-28">
                {/* <div className=" w-full h-[180px] lg:h-[380px] relative">
                    ...
                    <div className=" absolute top-1/2 -translate-y-1/2 right-1/2 translate-x-1/2 lg:py-6 py-2 px-3 lg:px-10 border-[10px] lg:border-[20px] border-red-400 flex justify-center items-center">
