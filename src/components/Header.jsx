...
export default function Header() {
  ...
  return (
    <div className=" z-50 bg-white fixed top-0 left-0 w-screen border-t-4  border-yellow-200 flex justify-center">
      {
        showSideNave &&
        <SideNave toggleShowSidNav={toggleShowSidNav} />
      }
      <div className="w-full 2xl:w-[1200px] py-2 relative">
        {/* top part start */}
        ...
        <div className={`flex justify-between  transition-all duration-200 ease-in-out ${showSubHeader ? "h-0 opacity-0 py-0" : " py-2 h-auto opacity-100"}`}>
          <div className=" flex items-center gap-2">
            ...
            <div className=" flex gap-2 items-center font-semibold py-2 px-2 text-sm  cursor-pointer border-b-2 border-transparent hover:border-blue-950">
              <span>More</span>
              <AiOutlinePlus />
            </div>
          </div>
